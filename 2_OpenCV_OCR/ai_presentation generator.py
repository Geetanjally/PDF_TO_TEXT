...
def print_blueprint(slides_data):
    print("\n" + "="*50)
    print(" 📊 PRESENTATION BLUEPRINT (PREVIEW)")
    print("="*50)
    try:
...
def create_pptx(slides_data, output_path, template_file=None):
    ...
    if template_file and os.path.exists(template_file):
        print(f"🎨 Using design template: {template_file}")
        prs = Presentation(template_file)
    else:
        print("⚪ Using default blank design.")
        prs = Presentation()
    # ----------------------
    ...
    try:
        ...
        print(f"⚠️ Warning: Could not create standard title slide (Template might differ). {e}")
    ...
    for entry in data:
        ...
        try:
            ...
            print(f"⚠️ Warning: Could not place text on slide '{entry.get('title')}'")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\n📖 Analyzed text. Designing structure...")
        ...
        while True:
            ...
            print("\nOPTIONS:")
            print("1. ✅ Approve & Generate PPT")
            print("2. 💬 Give instructions to modify")
            print("3. ❌ Exit")
            ...
            if choice == '1' or choice == 'yes' or choice == 'approve':
                ...
                instruction = choice if len(choice) > 3 else input("💬 Instruction: ")
                print("\n🔄 Updating...")
